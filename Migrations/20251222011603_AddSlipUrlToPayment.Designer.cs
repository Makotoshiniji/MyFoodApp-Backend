...
namespace My_FoodApp.Migrations
{
    ...
    [Migration("20251222011603_AddSlipUrlToPayment")]
    partial class AddSlipUrlToPayment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("My_FoodApp.Models.OrderItem", b =>
                {
                    ...
                    b.Property<string>("ItemOptionIds")
                        .HasColumnType("longtext")
                        .HasColumnName("item_option_ids");
            ...
            modelBuilder.Entity("My_FoodApp.Models.User", b =>
                {
                    ...
                    b.Property<string>("UserProfilePath")
                        .HasColumnType("longtext")
                        .HasColumnName("user_profile_path");
            ...
            modelBuilder.Entity("OrderItemOption", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OrderItemOption", b =>
                {
                    b.HasOne("My_FoodApp.Models.OrderItem", "OrderItem")
                        .WithMany("Options")
                        .HasForeignKey("OrderItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_order_item_option_order_items_order_item_id");
